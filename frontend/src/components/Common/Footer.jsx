        ...
        <div className='container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0'>
            ...
            <div>
                ...
                <ul className='space-y-2 text-gray-600'>
                    <li>
                        <Link to="#" className='hover:text-gray-500 transition-colors'> Mens Casual</Link>
                    </li>
                    <li>
                        <Link to="#" className='hover:text-gray-500 transition-colors'> Mens Sneakers</Link>
                    </li>
                    <li>
                        <Link to="#" className='hover:text-gray-500 transition-colors'> Womens Casual</Link>
                    </li>
                    <li>
                        <Link to="#" className='hover:text-gray-500 transition-colors'> Womens Sneakers</Link>
                    </li>
                </ul>
            </div>
            {/* Support Links */}
