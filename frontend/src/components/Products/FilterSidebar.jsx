...
const categories = ["sneakers","boots","sandals","formal"];
    ...
    <div className='p-4 rounded-lg '>
        ...
        <div className="mb-6">
            ...
            <div className="flex flex-wrap gap-2">
                {colors.map((color) => (
                    <button key={color} className={`w-8 h-5 rounded-full border border-gray-300 cursor-pointer transition hover:scale-110 ${filters.color === color ? 'ring-2 ring-blue-500' : ''}`} value={color} onClick={handleFilterChange}
         ...
         <div className="mb-6">
            ...
            {materials.map((material)=>(
                <div key={material} className="flex items-center mb-1">
                    <input type="checkbox" name="material" className='mr-2 h-4 w-4 text-blue-500 focus:ring-blue-400 border-gray-300' value={material} onChange={handleFilterChange} checked={filters.material.includes(material)}/>
