...
const selectedProduct = {
    ...
    brand:"Nike",
    material:"Leather",
    sizes:["US:10","US:12","US:14","US:11.5"],
    colors: ["Black","Red"],
    images: [{
...
const ProductDetails = () => {
    ...
    const handleQuantityChange = (action) => {
        ...
        } else if(action === "minu" && quantity > 1){
            setQuantity((prevQuantity) => prevQuantity - 1);
        }
    }
                        ...
                        <div className="md:w-1/3 md:ml-40  ">
                            ...
                            <div className="mb-4">
                                ...
                                <div className="flex gap-2 mt-2">
                                    {selectedProduct.sizes.map((size) =>(
                                        ...
                                        className={`px-4 py-2 rounded border hover:bg-gray-100 ${selectedSize === size ? "bg-black hover:bg-gray-900 text-white" : ""}`} >
                                            {size}</button>
                                    ))}
                                </div>
                            </div>
                            <div className="mb-6">
                                ...
                                <div className='flex items-center space-x-4 mt-2'>
                                    <button onClick={() => handleQuantityChange("minu")}
                            ...
                            className={`bg-black text-white py-4 px-6 rounded-xl w-full mb-4 ${isButtonDisabled ? "opacity-50 cursor-not-allowed" : "hover:bg-gray-900"}`}> 
